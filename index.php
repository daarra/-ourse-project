...
<div class="carousel-inner">
  ...
  <br/> Хотим обратить Ваше внимание, что данный раздел доступен только <strong>авторизированным</strong> пользователям с ролью <strong>"Аналитик"</strong>.
  <br/>Если Вы хотите получить доступ к датасету, пожалуйста, обратитесь по почте, упомянутой в контактах внизу страницы.</p>
</div>
